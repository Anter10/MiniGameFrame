window.__require = function e(t, n, r) {
  ...
  MNGConst: [ function(require, module, exports) {
    (function(Buffer) {
      "use strict";
      cc._RF.push(module, "9910fqx0yJKkr0rUtanDesy", "MNGConst");
      "use strict";
      ...
      MNGConst.showWXVideo = function(params) {
        ...
        WXVedioAD.load().then(function() {
          ...
          100 * Math.random() <= lucky_rate ? WXVedioCallback.err_cb && WXVedioCallback.err_cb() : MNGConst.showWXModal("\u83b7\u53d6\u89c6\u9891\u5931\u8d25");
        });
  ...
  PhyFrameWorld: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "f88ea7zOdBH0LTOcs03ZClg", "PhyFrameWorld");
    "use strict";
    var self = null;
    cc.Class({
      extends: cc.Component,
  ...
  ResConfig: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "135f8HqGlJNuYlXNwXtRG4g", "ResConfig");
    "use strict";
    cc._RF.pop();
  }, {} ],
  ShareButton: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "5a8a2wSwQZPTbOgvK312B9l", "ShareButton");
    "use strict";
    cc.Class({
      extends: cc.Component,
      properties: {
  ...
  WebSocket: [ function(require, module, exports) {
    ...
    var WebSocket = {
      ...
      timerSchedule: function timerSchedule() {
        ...
        2 == WebSocket.tickCount && WebSocket.connectStatus == WebSocket.CONNECT_STATUS_OK && WXSdk.NotificationCenter.trigger(WXSdk.EventType.SEND_HEART_BEAT);
        WebSocket.reconnet();
      },
      ...
      connect: function connect(url) {
        ...
        if (WebSocket.connectStatus == WebSocket.CONNECT_STATUS_OPENING || WebSocket.connectStatus == WebSocket.CONNECT_STATUS_OK) return;
        WebSocket.connectStatus = WebSocket.CONNECT_STATUS_OPENING;
        WXSdk.IsWechatPlatform() && this.doWechatConnect(url);
      },
      doWechatConnect: function doWechatConnect(url) {
        try {
          if (!WXSdk.IsWechatPlatform()) return;
          wx.connectSocket({
            url: url
          });
          wx.onSocketOpen(function(res) {
            ...
            WebSocket.isTimerInited || WebSocket.startCheckTimer();
          });
          ...
          wx.onSocketMessage(function(res) {
            if (!WXSdk.StateInfo.isOnForeground) return;
            ...
            if (null != strJson && strJson.length > 0) {
              ...
              -1 == WebSocket.filterCmds.indexOf(_json.cmd) && WXSdk.LOGD(WebSocket.TAG, msgStr);
      ...
      sendMsg: function sendMsg(data) {
        try {
          if (WebSocket.connectStatus != WebSocket.CONNECT_STATUS_OK) return;
          var msgStr = JSON.stringify(data);
          -1 == WebSocket.filterCmds.indexOf(data.cmd) && WXSdk.LOGD(WebSocket.TAG, "TCP sendMsg:" + msgStr);
          WXSdk.IsWechatPlatform() && wx.sendSocketMessage({
            data: msgStr,
      ...
      close: function close() {
        try {
          ...
          WXSdk.IsWechatPlatform() && wx.closeSocket();
  ...
  goldcoin: [ function(require, module, exports) {
    "use strict";
  ...
  test: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "f20e9mCoPNLeILhNkAPYAKF", "test");
    "use strict";
    cc.Class({
      extends: cc.Component,
      properties: {
      ...
      onLoad: function onLoad() {
        ...
        this._addBound(node, width / 4, 0, 20, height / 2);
        node.parent = this.node;
        for (var row = 0; row < 1; row++) for (var column = 1; column < 6; column++) {
          var com = cc.instantiate(this.goldprefab);
          com.parent = this.node;
          com.x = (110 * row - 360) / 32;
          com.y = (110 * column - 640) / 32;
        }
      },
      _addBound: function _addBound(node, x, y, width, height) {
        var collider = node.addComponent(cc.PhysicsBoxCollider);
      ...
      update: function update(dt) {
        ...
        collider && console.log("ggg");
      }
    });
    cc._RF.pop();
  }, {} ]
}, {}, [ "ResConfig", "Http", "MNGConst", "ShareButton", "WebSocket", "Collider", "PhyFrameWorld", "physics-bound", "HelloWorld", "test", "goldcoin" ]);